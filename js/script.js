...
const words = [];
if(localStorage.getItem("range1") == "true"){
    words.push(...words1);
}
if(localStorage.getItem("range2") == "true"){
    words.push(...words2);
}
if(localStorage.getItem("range3") == "true"){
    words.push(...words3);
}
if(localStorage.getItem("range4") == "true"){
    words.push(...words4);
}
if(localStorage.getItem("range5") == "true"){
    words.push(...words5);
}
if(localStorage.getItem("range6") == "true"){
    words.push(...words6);
}
if(localStorage.getItem("range7") == "true"){
    words.push(...words7);
}
if(localStorage.getItem("range8") == "true"){
    words.push(...words8);
}
if(localStorage.getItem("range9") == "true"){
    words.push(...words9);
}
if(localStorage.getItem("range10") == "true"){
    words.push(...words10);
}
if(localStorage.getItem("range11") == "true"){
    words.push(...words11);
}
if(localStorage.getItem("range12") == "true"){
    words.push(...words12);
}
if(words.length === 0){
    alert("設定で単語帳を1つ以上選択してください。");
